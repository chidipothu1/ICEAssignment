...
class FootballData {
     ...
     * @return \Soccerseason object
     */        
    public function getSoccerseasonByYear($id) {
        $resource = "competitions/$id/leagueTable";
        $response = file_get_contents($this->baseUri . $resource, false, 
                                      stream_context_create($this->reqPrefs));
        $result = json_decode($response);
     ...
     * @return \Soccerseason object
     */        
    public function getSoccerseasonByYear1($id) {
        $resource = "competitions/?season=2017";
        $response = file_get_contents($this->baseUri . $resource, false, 
                                      stream_context_create($this->reqPrefs));
        $result = json_decode($response);
	...
	public function getSoccerseasonFixtures($id) {
    ...
    public function getTeams() {
        $resource = 'competitions/398/teams';
        $response = file_get_contents($this->baseUri . $resource, false, 
                                      stream_context_create($this->reqPrefs));
